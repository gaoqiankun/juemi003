...
#   ./docker/trellis2/build.sh --image cubie3d/trellis2:20260315
#   ./docker/trellis2/build.sh --image cubie3d/trellis2:20260315 --platform linux/amd64
#   ./docker/trellis2/build.sh --image cubie3d/trellis2:20260315 --push
#
...
DEFAULT_IMAGE="cubie3d/trellis2:latest"
LATEST_IMAGE="cubie3d/trellis2:latest"
IMAGE="$DEFAULT_IMAGE"
DO_PUSH="0"
...
Options:
  --image IMAGE       target image name (default: cubie3d/trellis2:latest)
                      if IMAGE is not tagged :latest, also tag cubie3d/trellis2:latest
                      and push that latest tag too when --push is set
  --platform VALUE    docker build platform (default: linux/amd64)
  --push              push IMAGE; if auto-tagged, also push cubie3d/trellis2:latest
