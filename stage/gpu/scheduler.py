...
from gen3d.core.observability.metrics import initialize_gpu_slots, set_gpu_slot_active
...
class GPUSlotScheduler:
    ...
    async def acquire(
        ...
        *,
        ...
        try:
            ...
            await self.cancel_task(shutdown_task)
            await self.cancel_task(get_task)
            if acquired_device_id is None:
                self.restore_slot_from_task(get_task)
    ...
    def restore_slot_from_task(self, task: asyncio.Task[str] | None) -> None:
