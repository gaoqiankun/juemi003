...
class ModelRegistry:
    ...
    def get_state(self, model_name: str) -> str:
        entry = self._entries.get(self.normalize_name(model_name))
    ...
    def load(self, model_name: str, *, device_id: str | None = None) -> None:
        normalized = self.normalize_name(model_name)
    ...
    async def load_worker(self, model_name: str, entry: _ModelEntry) -> None:
        try:
            worker = await self.invoke_worker_factory(
                model_name,
        ...
        *,
        ...
        while True:
            try:
                ...
                return self.coerce_factory_result(worker_obj)
