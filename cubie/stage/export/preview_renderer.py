...
from cubie.stage.export.preview_protocol import read_message_sync, write_message_sync
...
def main(argv: list[str] | None = None) -> int:
    ...
    if len(args) != 2:
        print("usage: python -m cubie.stage.export.preview_renderer <model.glb> <preview.png>", file=sys.stderr)
        print("   or: python -m cubie.stage.export.preview_renderer --serve", file=sys.stderr)
        return 2
