...
from gen3d.stages.export.preview_protocol import read_message_sync, write_message_sync
...
def main(argv: list[str] | None = None) -> int:
    ...
    if len(args) != 2:
        ...
        print("   or: python -m gen3d.stages.export.preview_renderer --serve", file=sys.stderr)
        return 2
